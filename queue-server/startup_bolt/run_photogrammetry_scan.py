...
def upload_photogrammetry_image_stack_to_tiled(image_dir, scan_timestamp, scan_params):
    ...
    try:
        ...
        # Create container for the image stack
        stack_container_path = f"photogrammetry_image_stacks_{scan_type}"
        ...
        # Create unique key for the stack
        import random
        random_suffix = random.randint(1000, 9999)
        stack_key = f"image_stack_{scan_timestamp}_r{random_suffix}"
