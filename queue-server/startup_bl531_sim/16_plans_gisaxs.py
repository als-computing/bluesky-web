...
# SIM DELTA: the beamline file hardcodes http://192.168.10.155:8000 here, which
# hangs on a connect timeout and fails the environment open. Read-only access,
# so no API key is needed (config_sim.yml allows anonymous reads).
import os

from tiled.client import from_uri
tiled_client = from_uri(os.getenv("TILED_URI", "http://tiled:8000"))
