...
export default function QItemPopup( {popupItem={}, handleQItemPopupClose=()=>{}, isItemDeleteButtonVisible=true, handleCopyItemClick=()=>{} } ) {
    ...
    const Row = (name, icon, content) => {
        ...
        return (
            <div name="background" onClick={handleQItemPopupClose} className={`absolute top-0 left-0 w-full h-full z-20 ${getPlanColorOpacity(popupItem.name)} flex justify-center items-center ${isDeleteModeVisible ? 'bg-red-600/40' : ''}`}>
