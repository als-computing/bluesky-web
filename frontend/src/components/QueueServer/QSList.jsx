    ...
    if (type === 'default') {
        return (
            <section className="">
                ...
                <ul className="flex flex-row-reverse mt-2 overflow-auto justify-evenly" style={{'scrollbarColor': 'grey black'}}>
        ...
        return (
            <section className="h-full w-full flex flex-col ">
                ...
                <ul ref={listRef} className="flex flex-col-reverse space-y-12 h-[90%] overflow-y-auto" style={{'scrollbarColor': 'grey rgb(15 23 42)'}}>
