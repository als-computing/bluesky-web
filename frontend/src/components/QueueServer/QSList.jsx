...
export default function QSList({ queueData=[], handleQItemClick=()=>{} }) {
    ...
    return (
        <section className="">
            ...
            <ul className="flex flex-row-reverse border-r border-r-white pr-2 mt-2">
                {queueData.map((item, index) => <QItem item={item} index={index} key={item.item_uid} handleClick={handleQItemClick}/>)}
