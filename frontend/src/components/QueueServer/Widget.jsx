...
export default function Widget({children, title='', icon='', expandedHeight="h-fit", defaultHeight='h-1/4', maxHeight='max-h-3/4'}) {
    ...
    return (
        <div className={`${hideContent ? 'h-fit hover:cursor-pointer' : (isExpanded ? expandedHeight : defaultHeight)} ${maxHeight} rounded-md border border-slate-600 flex-shrink-0`}>
